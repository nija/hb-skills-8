...
# In the Node class, finish the method called
# get_num_children. This function could be used to
# count the number of people that person supervises.

# In the Tree class, finish the method called
