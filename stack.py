# Assignment:
# In the file called stack.py, there is a class 
# definition and some methods for a Stack class.
# Finish the methods for length.
# Finish the method for empty.
# Finish the method for is_empty.
